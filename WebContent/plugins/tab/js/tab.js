...
function TabView(f) {
    ...
    if ($("#scrollContent").attr("childScrollContent") == "true") {
        i = '<iframe id="{0}"  allowTransparency="true" frameborder="0" width="100%" height="100%" src="{1}"></iframe>';
    } else {
        i = '<iframe id="{0}"  style="overflow-x:hidden;overflow-y:hidden;" allowTransparency="true" frameborder="0" width="100%" height="100%" src="{1}"></iframe>';
    }
