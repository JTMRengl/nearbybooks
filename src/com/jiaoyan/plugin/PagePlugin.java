...
import com.jiaoyan.util.ReflectHelper;
...
public class PagePlugin implements Interceptor {
		...
		if(invocation.getTarget() instanceof RoutingStatementHandler){
			...
			if(mappedStatement.getId().matches(pageSqlId)){ //拦截需要分页的SQL
				...
				if(parameterObject==null){
					...
					String pageSql = PageSql(sql,page);
	...
	private String PageSql(String sql,Page page){
		if(page!=null && Tools.notEmpty(dialect)){
			...
			int thisPage = page.getPageSize();
			switch (dialect) {
				case "mysql":
					pageSql.append(sql+" limit "+page.getCurrentResult()+","+thisPage);
					break;
				default:
					pageSql.append(sql);
					break;
